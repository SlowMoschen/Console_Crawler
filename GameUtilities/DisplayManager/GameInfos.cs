...
;            Console.WriteLine();
            ...
            Console.WriteLine($"                Stun prevents the player from attacking for the next turn.");
            Console.WriteLine();
            Console.WriteLine("     Goblin King (Mini Boss):");
            Console.WriteLine();
            Console.WriteLine($"        Health: {AllEnemyStatistics.GoblinKing.BaseHealth}");
            Console.WriteLine($"        Attack: {AllEnemyStatistics.GoblinKing.BaseAttack}");
            Console.WriteLine($"        Armor: {AllEnemyStatistics.GoblinKing.BaseArmor}");
            Console.WriteLine($"        Strength: {AllEnemyStatistics.GoblinKing.Strength}");
            Console.WriteLine($"        EXP: {AllEnemyStatistics.GoblinKing.BaseEXP}");
            Console.WriteLine($"        Gold: {AllEnemyStatistics.GoblinKing.Gold}");
            Console.WriteLine($"        Special Attacks:");
            Console.WriteLine();
            Console.WriteLine("            Enrage:");
            Console.WriteLine("                If the Goblin King is already enraged, he will get another random action.");
            Console.WriteLine($"                Increases the Goblin King's attack by {AllEnemyStatistics.GoblinKing.EnrageExtraAttack} and his armor by {AllEnemyStatistics.GoblinKing.EnrageExtraArmor} for {AllEnemyStatistics.GoblinKing.EnragedTurns} turns.");
            Console.WriteLine();
            Console.WriteLine("            Treasure Drain:");
            Console.WriteLine();
            Console.WriteLine($"                Deals damage to the player and steals {AllEnemyStatistics.GoblinKing.StealAmount} gold from the player.");
            Console.WriteLine($"                After defeating the Goblin King, he will be dropping a random amount of gold wich will be chosen between the base gold and the gold that the goblin has stolen.");
            Console.WriteLine($"                In addition the Goblin King got a {AllEnemyStatistics.GoblinKing.ItemStealChance}% Chance to steal an Item from your Inventory");
            Console.WriteLine();
            Console.WriteLine("            Golden Barrage:");
            Console.WriteLine();
            Console.WriteLine($"                Deals damage based on the Gold the Goblin King currently has in its Inventory.");
            Console.WriteLine("                 It will loose some of its Gold using this Special Attack.");   
            Console.WriteLine();
